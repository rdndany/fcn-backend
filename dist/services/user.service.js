...
function getUserCoinsPending(_a) {
    return __awaiter(this, arguments, void 0, function* ({ pageSize, pageNumber, userId, }) {
        try {
            ...
            // Cache results
            yield redis_config_1.redisClient.setex(cacheKey, 300, JSON.stringify(result)); // 5 minutes cache
...
function userCoinById(coinId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const coin = yield coin_model_1.default.findById(coinId).lean();
            if (!coin) {
                logger.warn("No coin found with ID:", { coinId });
                return null;
            }
            // Fetch the user using the coin's author field
            const user = (yield user_model_1.default.findById(coin.author)
                .select({
                _id: 1,
                email: 1,
                name: 1,
            ...
            yield redis_config_1.redisClient.setex(cacheKey, 300, JSON.stringify(user));
